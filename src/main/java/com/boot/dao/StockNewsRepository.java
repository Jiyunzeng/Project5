...
public interface StockNewsRepository extends MongoRepository<StockNews, String> {
    ...
    Page<StockNews> findByRegion(String region, Pageable pageable);

    Page<StockNews> findByRegionAndTitleContainingIgnoreCase(String region, String keyword, Pageable pageable);
